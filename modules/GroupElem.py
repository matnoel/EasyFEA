"""
I considered renaming 'GroupElem.py' to 'GroupElems.py', but faced issues with loading old damage simulations.
...
myPrintError("Link GroupElem.py to GroupElems.py (DO NOT USE IT)")
from GroupElems import *